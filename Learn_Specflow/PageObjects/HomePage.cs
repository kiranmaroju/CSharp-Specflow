    ...
    class HomePage
    {
        ...
        public void VerifyCart()
        {
            ...
            for (int p=0;p<products;p++) 
            {
                ...
                Assert.AreEqual(expProductQty, int.Parse(actItemQtyElm.Text));
                
                //table[@id='cart_summary']//tr[contains(@id, 'product')][2]//*[@class='price']
                //table[@id='cart_summary']//tr[contains(@id, 'product')][2]//*[@class='cart_quantity_input form-control grey']
                //table[@id='cart_summary']//tr[contains(@id, 'product')][2]//*[@class='cart_unit']//span[@class='price']
                //table[@id='cart_summary']//tr[contains(@id, 'product')][2]//*[@class='cart_total']//span[@class='price']
            }
        ...
        //checkoutLink, termsAcceptField, bankWireLink, orderConfLink, confMessage
